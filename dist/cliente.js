...
yargs(hideBin(process.argv)).command('add', 'Adds a funko', {
    ...
    addFunko(argv.id, argv.user, argv.nombre, argv.descripcion, argv.tipo, argv.genero, argv.franquicia, argv.numero, argv.exclusivo, argv.caracteristicasEspeciales, argv.valorMercado);
}).help().argv;
...
yargs(hideBin(process.argv)).command('modify', 'Modifies a funko', {
    ...
    modificarFunko(argv.id, argv.user, argv.nombre, argv.descripcion, argv.tipo, argv.genero, argv.franquicia, argv.numero, argv.exclusivo, argv.caracteristicasEspeciales, argv.valorMercado);
}).help().argv;
